    ...
    >
        ...
        <div className="flex-1 grid grid-cols-12 gap-3 items-center">
          ...
          <div className="col-span-4 flex items-center">
            <input
              ...
              value={field.key}
              onChange={(e) =>
                ctx.onUpdateField(field.id, { key: e.target.value })
              }
          ...
          <div className="col-span-3">
            <div className="relative">
              <select
                value={field.type}
                onChange={(e) =>
                  ctx.onUpdateField(field.id, { type: e.target.value as any })
                }
            ...
            {field.type === "object" ? (
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  placeholder={
                    field.type === "array" ? '["item1", "item2"]' : "Value"
                  }
                  value={field.value}
                  onChange={(e) =>
                    ctx.onUpdateField(field.id, { value: e.target.value })
                  }
      ...
      {field.type === "object" &&
        ...
        (!field.children || field.children.length === 0) && (
          <div className="pl-12 pb-2 text-[10px] text-slate-400 italic">
            Empty object
          </div>
        )}
    ...
    >
      {tokens.map((token, i) => {
        ...
        if (token.startsWith('"')) {
          if (
            token.endsWith('":') ||
            (tokens[i + 1] && tokens[i + 1].trim().startsWith(":"))
          ) {
...
export const MockEditor: React.FC<MockEditorProps> = ({
  ...
  const [activeGeneratorDropdown, setActiveGeneratorDropdown] = useState<
    string | null
  >(null);
  ...
  useEffect(() => {
    if (formData.path && formData.method) {
      ...
      if (isConflict) {
        setConflictError(
          `Route conflict: ${formData.method} ${formData.path} already exists.`
        );
      } else {
  ...
  const executeRemoveField = (id: string) => {
    const removeRecursive = (list: SchemaField[]): SchemaField[] => {
      return list
        ...
        .map((field) => {
          if (field.children)
            return { ...field, children: removeRecursive(field.children) };
          return field;
        });
    };
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm mt-0.5">
              Configure endpoint behavior and data structure.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 overflow-y-auto pr-2 custom-scrollbar pb-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("statusCode", parseInt(e.target.value))
                    }
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-5">
            <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2 pb-2 border-b border-slate-100">
              <Shield className="w-4 h-4 text-rose-500" /> Authentication &
              Security
            </h3>

            <p className="text-xs text-slate-500 leading-relaxed">
              Protect your endpoint by requiring authentication credentials.
              Requests without valid credentials will return{" "}
            ...
            {formData.authConfig?.type === "NONE" && (
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
                <p className="text-xs text-slate-600 flex items-start gap-2">
                  ...
                  <span>
                    This endpoint is <strong>public</strong> and accessible
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 relative overflow-hidden">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Connect this endpoint to an in-memory database collection to
              simulate real CRUD operations (Create, Read, Update, Delete).
            </p>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("delay", parseInt(e.target.value))
                }
                ...
                <div className="flex-1 flex relative overflow-hidden">
                  ...
                  <div className="flex-1 relative w-full h-full overflow-hidden">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleChange("responseBody", e.target.value)
                      }
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-slate-600 mb-6">
                ...
                <strong className="text-slate-800">
                  {fieldToDelete.childrenCount} nested items
                </strong>
